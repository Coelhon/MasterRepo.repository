...
ADDON=xbmcaddon.Addon(id='plugin.video.MasterWizard')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/d6kjejmy83456in/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]MasterWizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
